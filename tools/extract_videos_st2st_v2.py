...
folder_root = "/home/daxiedong/dataset/SSV2/Something-Somethingv2"
...
def create_train_video(short_side):
    with open(train_file_list, 'w') as f, concurrent.futures.ProcessPoolExecutor(max_workers=36) as executor:
        futures = [executor.submit(video_to_images, video, video_folder, train_img_folder, int(short_side)) for video in train_videos]
