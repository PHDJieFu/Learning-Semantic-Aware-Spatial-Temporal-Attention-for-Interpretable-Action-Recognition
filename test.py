...
def main():
    ...
    # }
    # torch.save(save_dict, os.path.join('/home/daxiedong/code/action-recognition-pytorch/test', 'test.pth.tar'))
    ...
    if args.pretrained is not None:
        ...
        for i in checkpoint_dict.keys():
            print(i)
            print(checkpoint_dict[i].size())
